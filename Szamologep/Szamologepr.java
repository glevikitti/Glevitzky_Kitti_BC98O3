 ...
 * @author hallgato
 */
public class Szamologepr extends JFrame implements ActionListener {
    JLabel lb1;
    JLabel lb2;
    JLabel lb3;
    JLabel lb4;
    ...
    public Szamologepr(String title) throws HeadlessException {
        super(title);
        setVisible(true);
        ...
        GridLayout gr2= new GridLayout(4,1);//p2
        GridLayout gr3= new GridLayout(1,4); 
        GridLayout gr4= new GridLayout(4,1);
    ...
    public static void main(String[] args) {
        Szamologepr l= new Szamologepr("Idoatalakito");
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        int masodpercek=Integer.parseInt(tf4.getText())+Integer.parseInt(tf8.getText());
        int maradek1=0;
        if(masodpercek<60){
            ...
            maradek1=masodpercek/60;
        }
        int percek=Integer.parseInt(tf3.getText())+Integer.parseInt(tf7.getText())+maradek1;
        int maradek2=0;
        if(percek<60){
        ...
        int orak=Integer.parseInt(tf2.getText())+Integer.parseInt(tf6.getText())+maradek2;
        int maradek3=0;
        ...
        int napok=Integer.parseInt(tf1.getText())+Integer.parseInt(tf5.getText())+maradek3;
